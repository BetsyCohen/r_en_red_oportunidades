...
format:
  revealjs:
    ...
    chalkboard: false
    notes: false
footer: <https://www.nucleodeinnovacion.com/>
...
## Algunas ideas que nos guian{.smaller}

-   **Se transforma lo que se puede conocer**

    Transformamos el conocimiento en acciones, soluciones y productos tecnológicos con impactos concretos y medibles.
...
## Algunas historias en las que ayudamos a construir conocimiento {.smaller}

:::::::::::: columns
::: {.column width="60%"}
### Junto a les viejes {.smaller}
...
:::
:::{.column width="40%"}
![](images/ADISAC_viejes.png){fig-align="center" width="400px"}
:::
::::::::::::
...
:::{.column width="40%"}
![](images/CAL_informe_produ.jpg){fig-align="center" width="400px"}
:::
...
## Más historias de colaboración {.smaller}
...
:::
::: {.column width="40%"}
![](images/talleres.jpg){fig-align="center" width="400px"}
:::
:::::::::::: 
